...
#endif
{
	...
	scatterPlotView = [[CPLayerHostingView alloc] initWithFrame:NSMakeRect(0.0f,
																		   0.0f,
																		   viewRect.size.width, 
																		   viewRect.size.height * 0.5f)];
	
	barChartView = [[CPLayerHostingView alloc] initWithFrame:NSMakeRect(0.0f, 
																		viewRect.size.height * 0.5f, 
																		viewRect.size.width * 0.5f, 
																		viewRect.size.height * 0.5f)];
	
	pieChartView = [[CPLayerHostingView alloc] initWithFrame:NSMakeRect(viewRect.size.width * 0.5f,
																		viewRect.size.height * 0.5f, 
																		viewRect.size.width * 0.5f,
																		viewRect.size.height * 0.5f)];
